...
@synthesize isRefreshSuccess = _isRefreshSuccess;
#pragma mark - 控件初始化
/**
 *  状态标签
 */
...
{
    if (!_arrowImage) {
        UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"flreshArrow.png"]];
...
#pragma mark 结束刷新
- (void)endRefreshing:(BOOL)isRefreshSuccess
{
    self.isRefreshSuccess = isRefreshSuccess;
