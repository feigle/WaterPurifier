 ...
 *  @param targetView
 */
+ (void)animationLikeAlertView:(UIView*)targetView
{
...
//从上往下循环移动
+ (void)animationTransitionCurlDownWithView:(UIView *)view endFrame:(CGRect)frame repeats:(NSInteger)repeat duration:(float)duration
{
...
//    view.backgroundColor = [UIColor redColor];
    ...
    [UIView setAnimationTransition:UIViewAnimationTransitionCurlDown forView:view cache:YES];  //这句话估计得注释掉才行，有一次就因为这句话出现个小问题
