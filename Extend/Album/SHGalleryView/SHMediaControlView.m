...
//    [[UINavigationBar appearance] setBarTintColor:ColorFromRGB(0x004a80)];
    [self.navBar setBackgroundColor:ColorFromRGB(0x004a80)];
    self.navingationItem.title = @"图像浏览";
    [self.navBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor whiteColor],UITextAttributeTextColor,nil]];
//    self.btnPlay.frame = CGRectMake((MRScreenWidth-34)/2, 64 + (MRScreenHeight-64-34)/2, 34, 34);
}
