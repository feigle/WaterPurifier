...
//    _mediaControlView.backgroundColor = [UIColor redColor];
...
- (UIViewController<SHGalleryViewControllerChild> *)viewControllerAtIndex:(int)index {
    ...
    SHMediaItem *item = [_dataSource mediaItemIndex:index andSection:self.currentSection];
...
- (void)updateMediaControls {
    SHMediaItem *mediaItem = [_dataSource mediaItemIndex:self.currentIndex andSection:self.currentSection];
