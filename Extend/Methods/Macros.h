 ...
 *  隐藏/显示状态栏
 */
#define shuldStatusbarHidden(hidden) [[UIApplication sharedApplication] setStatusBarHidden:hidden withAnimation:UIStatusBarAnimationFade]
...
#define HOST                        @"http://water.test.dengke.me:80"//鄢吉
//是否加密
